...
HASURA_GRAPHQL_DB_NAME="%POSTGRES_POSTGRES_DB%"
HASURA_GRAPHQL_URL="http://localhost:8080"
HASURA_GRAPHQL_METADATA_DATABASE_URL="%POSTGRES_POSTGRES_STRING%"
HASURA_GRAPHQL_DATABASE_URL="%POSTGRES_POSTGRES_STRING%"
